...
public class Quiz {
    public static void main(String[] args) {
        ...
        7. 메소드 오버로딩에 대한 설명으로 틀린 것은 무엇입니까? 2 (리턴 타입은 무관)
          ➊ 동일한 이름의 메소드를 여러 개 선언하는 것을 말한다.
          ➋ 반드시 리턴 타입이 달라야 한다.
          ➌ 매개변수의 타입, 수, 순서를 다르게 선언해야 한다.
          ➍ 매개값의 타입 및 수에 따라 호출될 메소드가 선택된다.

        8. 인스턴스 멤버와 정적 멤버에 대한 설명으로 틀린 것은 무엇입니까? 2 (정적 블록은 복잡한 정적 멤버 초기화시 사용)
        ...
        11. 접근 제한에 대한 설명으로 틀린 것은 무엇입니까? 3 (같은 패키지 내에서 사용 가능)
        ...
        17. 다음 중 아래의 add 메서드를 올바르게 오버로딩 한 것은? (모두 고르시오) 2, 3, 4
                long add(int a, int b) { return a+b;}
          ➊ long add(int x, int y) { return x+y;} <- 매개변수의 타입, 개수가 같다.
